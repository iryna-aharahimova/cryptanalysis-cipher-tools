...
public class LogMessagesConstants {
    public static final String CONSOLE_MODE_STARTED = "Console mode started";
    public static final String GUI_MODE_STARTED = "GUI mode started";
    ...
    public static final String BRUTE_FORCE_SUCCEEDED_KEY  = "Brute force succeeded with key: {}";
}
